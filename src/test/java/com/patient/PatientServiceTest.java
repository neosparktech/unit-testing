...
//	private TestEntityManager testEntityManager;
	...
	void test_book_appointments_with_appointment_service_true() {
		...
		Mockito.when(appointmentService.bookAppointment(Mockito.any(PatientVO.class),Mockito.any(LocalDateTime.class))).thenReturn(true);
	...
	void test_book_appointments_with_appointment_service_false() {
		PatientVO testPatient = PatientVO.builder().firstName("John").lastName("Doe").dateOfBirth(LocalDate.now()).build();
		Mockito.when(appointmentService.bookAppointment(Mockito.any(PatientVO.class), Mockito.any(LocalDateTime.class)))
				.thenReturn(false);
